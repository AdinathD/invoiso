...
export const MasterHeader: React.FC<MasterHeaderProps> = ({ form, onChange, darkMode }) => {
    ...
    <>
      ...
      {isOpen && (
        <>
          ...
          {/* Drawer Sidebar */}
          <div 
            className={`fixed top-0 left-0 h-full w-[320px] shadow-2xl z-50 transform transition-transform duration-300 ease-in-out flex flex-col ${
              darkMode ? 'bg-gray-900 text-gray-100 border-r border-gray-800' : 'bg-white text-gray-900 border-r border-gray-200'
            }`}
          >
            {/* Drawer Header */}
